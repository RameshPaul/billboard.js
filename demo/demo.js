						...
						options: {
								data: {
										columns: [
												...
												["data3", 70, 60, 240, 100, 110, 10],
												["data4", 30, 350, 200, 380, 150, 250, 50, 80, 55, 220],
												["data5", 130, 100, 10, 200, 80, 50, 200, 123, 185, 98],
												["data6", 230, 153, 85, 300, 250, 120, 5, 84, 99, 289]
						...
						options: {
								...
								color: {
										...
										tiles: function() {
												...
												g.append("polygon")
														.attr("points", "5 0 6 0 0 6 0 5");
												g.append("polygon")
														.attr("points", "6 5 6 6 5 6");
				...
				ColorTiles3: {
						 ...
						 */
								...
								onrendered: function() {
										...
										d3.selectAll(".bb-circles-data1 circle")
												.style("fill", "blue");
								}
						}
				},
